<x-casteaching-layout>
    <div class="flex flex-col items-center">
        ...
        <div class="inline-block max-w-7xl w-5/6 bg-white rounded-lg shadow-lg px-4 py-4 md:px-6 xl:px-15 xl:py-5 2xl:px-20 2xl:py-10 m-4 border-t-2 border-indigo-500 rounded-t-none">
            <h2 class="text-gray-900 w-full uppercase font-bold text-2xl tracking-tight border-b border-gray-300">
                {{ $video->title }}
            </h2>
            <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
                <div class="px-4 py-2 bg-gray-100 shadow rounded-lg overflow-hidden">
